...
export class ArticleService {
  ...
  public async getArticleByLink(
    link: string,
    useDigitalLibraryFallback = true
    ...
    if (useDigitalLibraryFallback && this.digitalLibraryService) {
    ...
    // If no article found and choose to use digital library, try to get metadata using the digital library service
    if (useDigitalLibraryFallback && this.digitalLibraryService) {
      try {

...
Note that we encourage [_colocation_](https://nextjs.org/docs/app/building-your-application/routing/colocation) of components and pages. Therefore, if the component is only used in a single page, it should be placed in the same directory as the page.
